    ...
    return (
        <div className='my-4 py-[50px] md:pl-[120px] px-5 md:flex justify-between'>
            <div className='md:w-[40%]'>
                ...
                <div className='my-3 flex mx-auto mt-5 bg-white gap-2 rounded-3xl w-[70%] text-black cursor-pointer'>Google Button</div>
                <div className='flex mx-auto mt-5 py-2 px-2 bg-white gap-2 rounded-3xl items-center w-[70%] justify-center text-black hover:bg-gray-100 border-2 cursor-pointer'>Sign in with Email</div>
            ...
            <div className='md:w-[50%] h-120'>
                <img className='w-full h-full' src={'https://media.licdn.com/media//AAYAAgSrAAgAAQAAAAAAAGM6w-NyPk-_SVikYiCJ6V3Z-Q.png'} alt="image" />
            </div>
        </div>
    )
}
