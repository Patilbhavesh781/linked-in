  ...
  return (
    <div className="my-8">
      ...
      <div className="w-full mb-4">
        ...
        <br />
        <textarea value={data?.about} onChange={(e) => { onChangeHandle(e, 'about') }} className='p-2 mt-1 w-full border rounded-md' name="" id="" cols={10} rows={3}></textarea>
      </div>

      <div className="w-full mb-4">
        <label htmlFor="">Skills* (Add by separating comma)</label>
        <br />
        <textarea value={data?.skillInp} onChange={(e) => { onChangeHandle(e, 'skillInp') }} className='p-2 mt-1 w-full border rounded-md' name="" id="" cols={10} rows={3}></textarea>
      </div>
